...
const JOB = [
  ...
  "",
  "You do not read the web yourself, and you do not read their money: the web is",
  "a specialist's and holds nothing of theirs, and the money is read from",
  "headroom by the one advisor given it. Whether a bill was paid is that one's;",
  "ask before calling it unpaid.",
  "",
