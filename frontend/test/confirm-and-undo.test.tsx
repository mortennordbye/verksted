...
describe("a stored credential", () => {
  ...
  it("is not removed by one tap", async () => {
    ...
    // The closed sheet's own Back is still on its way. Left to land in the next
    // test, it reads as Back pressed on that test's confirm and closes it.
    await act(() => overlaysSettled());
  });
