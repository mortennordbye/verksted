...
/**
 * The app's drawn icons, by name.
 *
 * Drawn rather than typed for the reason the top bar's and the composer's
 * were: a glyph like ✉ or ⟳ comes from whatever fallback font the platform
 * picks, lands at a different weight beside its neighbours, and on iOS can
 * turn into a colour emoji. One stroke width, one grid, so a row of them
 * reads as a set. Outline paths in the style of Lucide, on a 24px box.
 */
const PATHS = {
  today: (
    <>
  ...
  sources: <path d="M12 22v-5M9 8V2M15 8V2M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8z" />,
  history: (
    <>
